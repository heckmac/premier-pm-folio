/** Maps project data slugs to their partial registry IDs */
export const SLUG_TO_PARTIAL: Record<string, string> = {
  ...
  "insurance-data-collection": "insurance-data-collection",
};
